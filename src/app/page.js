...
export default function HomePage() {
  ...
  const texts = [ "Welcome to Web3", "Your Assets You Control"];
    ...
    <div className="bg-gray-900 min-h-screen text-white font-sans">
      ...
      <main className="max-w-6xl mx-auto p-4">
        ...
        <div className="h-48 mb-8 bg-gray-800 rounded-xl overflow-hidden relative">
          ...
          <div className="overflow-hidden white-space-nowrap py-4">
            {/* <h2 className="text-5xl text-center ">Welcome to Web3</h2> */}

            <div className="flex w-max animate-scroll gap-16 text-5xl font-semibold text-gray-900 dark:text-white" ref={sliderRef}>
